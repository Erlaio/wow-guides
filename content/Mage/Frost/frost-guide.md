...
**Урезано (не удалено):**
- **Mirror Image** и **Greater Invisibility** остались как таланты класс-дерева, но потеряли дефенсивную ценность: Mirror Image (3 копии, ~15 сек) больше не снижает урон, Greater Invisibility (инвиз 20 сек) - без прежней защиты. Теперь это утилити, а не дефенсивы.
...
**Слабые:**
- Урезаны дефенсивы: Mass Barrier удалён, а Mirror Image и Greater Invisibility остались, но без дефенсивной ценности (теперь утилити)
...
- **[[mage-glossary#^icicles|Icicles]]** - талант; при 5 Icicles следующий [[mage-glossary#^frostbolt|Frostbolt]] превращается в [[mage-glossary#^glacial-spike|Glacial Spike]] (мощный каст). Отдельным талантом Glacial Spike не берётся
...
2. **Pre-cast [[mage-glossary#^frostbolt|Frostbolt]]** (Glacial Spike до пулла недоступен - Icicles копятся только в бою)
...
**Изменено в Midnight:** Mass Barrier удалён; Mirror Image и Greater Invisibility остались как таланты, но потеряли дефенсивную ценность (спек стал "aggressively squishy" по мнению сообщества).
