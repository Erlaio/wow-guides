---
tags: [wow, druid, restoration, raid, guide, normal]
created: 2026-03-22
---
...
- Lifebloom на танке
- Efflorescence под мили-группой

**Основная связка (каждые 12 сек):**
```
Swiftmend → Wild Growth → Rejuvenation (SotF) → Regrowth spam
```

**Когда рейд на полном ХП:**
- Wrath / Starsurge на босса
...
| Кулдаун | Когда жать |
|---|---|
| **Incarnation: ToL** | Когда рейд сильно просел. 3+ раза за бой |
| **Tranquility** | Когда Incarnation на CD и рейд в опасности |
| **Innervate** | Перед Incarnation (бесплатный спам) |

**Во время Incarnation:** спамь Regrowth + продолжай SM → WG

#### Если играешь Convoke the Spirits
...
| Кулдаун | Когда жать |
|---|---|
| **Nature's Swiftness + Regrowth** | Когда кто-то вот-вот умрёт |
| **Ironbark** | На танка перед бастером |
| **Barkskin** | На себя перед AoE |

---

### Soul of the Forest

После Swiftmend → **Rejuvenation** (90%). Если кто-то умирает → **Regrowth**.
