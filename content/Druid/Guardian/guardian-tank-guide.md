...
- [[druid-glossary#^catweaving|Catweaving]] через [[druid-glossary#^heart-of-the-wild|Heart of the Wild]] - [[druid-glossary#^fluid-form|Fluid Form]] + Persistence для вхождения в Cat Form на бёрсты
...
3. [[druid-glossary#^rip|Rip]] с 6+ комбо-поинтами если не висит
4. [[druid-glossary#^ferocious-bite|Ferocious Bite]] с 2+ комбо-поинтами при активном [[druid-glossary#^rip|Rip]]
5. Bear-генераторы: [[druid-glossary#^mangle|Mangle]], [[druid-glossary#^thrash|Thrash]], [[druid-glossary#^galactic-guardian|Galactic Guardian]] [[druid-glossary#^moonfire|Moonfire]]
...
7. Cat DPS: [[druid-glossary#^rake|Rake]] → [[druid-glossary#^shred|Shred]], [[druid-glossary#^swipe|Swipe]] если небезопасно
